...
#start of problems I was unable to figure out from jump. Pulled copy of source and reviewed it
...
start_point = 10000
jelly_beans, jars, crates = secret_formula(start_point) #beans was not defined. Changed to relect 'jelly_beans'
